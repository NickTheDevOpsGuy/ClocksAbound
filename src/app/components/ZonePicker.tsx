    ...
    <div className="flex items-center gap-3">
      ...
      <div className="flex flex-wrap items-center gap-2 rounded-lg border border-slate-800 bg-slate-900/50 px-2 py-1">
        ...
        <input
          ...
          className="h-9 w-52 rounded-md border border-slate-800 bg-slate-950 px-3 text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-slate-600"
          value={query}
        ...
        <select
          className="h-9 min-w-56 rounded-md border border-slate-800 bg-slate-950 px-2 text-slate-100 focus:outline-none focus:ring-2 focus:ring-slate-600"
          value={selected}
